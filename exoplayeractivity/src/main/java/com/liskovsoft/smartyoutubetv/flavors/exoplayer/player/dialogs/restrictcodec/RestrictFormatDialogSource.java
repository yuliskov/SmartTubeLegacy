...
public class RestrictFormatDialogSource extends ExoDialogSource implements SingleDialogSource {
    ...
    public RestrictFormatDialogSource(Context ctx, PlayerView playerView) {
        ...
        mItems.add(new RestrictFormatDialogItem("2K     30fps    vp9+hdr", "1440|30|vp9|hdr", mPrefs));
        ...
        mItems.add(new RestrictFormatDialogItem("4K     30fps    vp9+hdr", "2160|30|vp9|hdr", mPrefs));
        ...
        mItems.add(new RestrictFormatDialogItem("8K     30fps    vp9", "4320|30|vp9", mPrefs));
        //mItems.add(new RestrictFormatDialogItem("8K     30fps    avc+vp9", "4320|30|", mPrefs));
        mItems.add(new RestrictFormatDialogItem("8K     30fps    vp9+hdr", "4320|30|vp9|hdr", mPrefs));
        //mItems.add(new RestrictFormatDialogItem("8K     30fps    avc+vp9+hdr", "4320|30||hdr", mPrefs));
        mItems.add(new RestrictFormatDialogItem("8K     60fps    vp9", "4320|60|vp9", mPrefs));
        //mItems.add(new RestrictFormatDialogItem("8K     60fps    avc+vp9", "4320|60|", mPrefs));
        mItems.add(new RestrictFormatDialogItem("8K     60fps    vp9+hdr", "4320|60|vp9|hdr", mPrefs));
        //mItems.add(new RestrictFormatDialogItem("8K     60fps    avc+vp9+hdr", "4320|60||hdr", mPrefs));
    }
