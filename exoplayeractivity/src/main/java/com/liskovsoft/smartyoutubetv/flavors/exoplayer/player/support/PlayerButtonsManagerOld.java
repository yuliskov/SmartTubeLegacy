...
public class PlayerButtonsManagerOld {
    private static final String TAG = PlayerButtonsManagerOld.class.getSimpleName();
    ...
    private static final int[] STANDALONE_BUTTONS = {R.id.exo_search, R.id.exo_user, R.id.exo_suggestions, R.id.down_catch_button, R.id.exo_favorites};

    public PlayerButtonsManagerOld(ExoPlayerBaseFragment playerFragment) {
    ...
    public void onCheckedChanged(ToggleButtonBase button, boolean isChecked) {
        ...
        boolean isSearchButton = id == R.id.exo_search;
        ...
        if (isSpeedButton) {
            ...
            //mPlayerFragment.onPlayerAction(ExoPlayerFragment.BUTTON_SEARCH);
        }
    }
