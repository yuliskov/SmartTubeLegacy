...
public final class Log {
  ...
  public static void setLogLevel(@LogLevel int logLevel) {
    //com.google.android.exoplayer2.util.Log.logLevel = logLevel;
  }
  ...
  public static void setLogStackTraces(boolean logStackTraces) {
    //com.google.android.exoplayer2.util.Log.logStackTraces = logStackTraces;
  }
  ...
  public static void d(String tag, String message) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.d(tag, message);
  }
  ...
  public static void d(String tag, String message, @Nullable Throwable throwable) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.d(tag, message, throwable);
  }
  ...
  public static void i(String tag, String message) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.i(tag, message);
  }
  ...
  public static void i(String tag, String message, @Nullable Throwable throwable) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.i(tag, message, throwable);
  }
  ...
  public static void w(String tag, String message) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.w(tag, message);
  }
  ...
  public static void w(String tag, String message, @Nullable Throwable throwable) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.w(tag, message, throwable);
  }
  ...
  public static void e(String tag, String message) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.e(tag, message);
  }
  ...
  public static void e(String tag, String message, @Nullable Throwable throwable) {
    ...
    com.liskovsoft.smartyoutubetv.common.mylogger.Log.e(tag, message, throwable);
  }
