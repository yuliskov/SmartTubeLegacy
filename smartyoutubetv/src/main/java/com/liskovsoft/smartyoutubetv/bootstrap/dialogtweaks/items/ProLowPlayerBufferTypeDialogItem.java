...
public class ProLowPlayerBufferTypeDialogItem extends DialogItem {
    private final SmartPreferences mPrefs;
    private final Context mContext;

    public ProLowPlayerBufferTypeDialogItem(Context context) {
        super(context.getResources().getString(R.string.low_player_buffer), false);
