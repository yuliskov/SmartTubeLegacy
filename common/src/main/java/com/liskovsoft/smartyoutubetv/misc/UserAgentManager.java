...
public class UserAgentManager {
    ...
    private final static String[] LG_SMART_TV = {
            // 2013
    ...
    private final static String[] SAMSUNG_SMART_TV = {
    ...
    private final static String[] PHILIPS_SMART_TV = {
     ...
     */
    private final static String[] COBALT_CLIENT = {
